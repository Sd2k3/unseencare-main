...
// Ensure cn (classNames) utility is available
import { ImgHTMLAttributes } from "react"; // Import the correct type for images
...
const BlurImage = ({ height, width, src = "", className, alt, ...rest }: ImageProps) => {
    ...
    return (
      <img
        ...
        src={typeof src === "string" && src.length > 0 ? src : "/fallback-image.jpg"} // Provide a fallback image
        width={width}
        height={height}
        decoding="async"
        loading="lazy"
